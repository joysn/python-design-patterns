...
print("Sarah:- ",rule3.interpret('Sarah'))
print("*****************")
print("Sarah Mary:- ",rule3.interpret('Sarah Mary'))
print("*****************")
print("Sarah John:- ",rule3.interpret('Sarah John'))
print("*****************")
print("Sarah John Henry:- ",rule3.interpret('Sarah John Henry'))
print("*****************")
